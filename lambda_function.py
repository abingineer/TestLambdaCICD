...
def lambda_handler(event, context):
    ...
    destination_bucket = 'text2talk-target-audio-bucket-demo' ## Update the target bucket name accordingly as per bucket name in your account
    ...
    try:
        response = polly_client.synthesize_speech(
            OutputFormat='mp3',
            Text=text,
            VoiceId='Kevin'  # You can choose a different voice IDs too
        )
